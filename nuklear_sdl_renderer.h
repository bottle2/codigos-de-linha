...
#include <SDL2/SDL.h>
NK_API struct nk_context*   nk_sdl_init(SDL_Window *win, SDL_Renderer *renderer, struct nk_user_font *font);
...
nk_sdl_init(SDL_Window *win, SDL_Renderer *renderer, struct nk_user_font *font)
{
